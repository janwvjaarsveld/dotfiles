...
--   command = "yarn nx run client:test", -- a command to run the test runner
...
-- )
-- vim.keymap.set("n", "<leader>jl", vim.cmd.TestLast, { noremap = true, silent = true, desc = "Run [L]ast test" })
